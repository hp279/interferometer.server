...
public class Matrix22 {
    ...
    public double getNorm1() {
        return Math.abs(get11()) + Math.abs(get12()) + Math.abs(get21())
                + Math.abs(get22());
    }

    public double getNorm2() {
        return Math.sqrt(get11() * get11() + get12() * get12() + get21()
                * get21() + get22() * get22());
    }

    // eps - погрешность в определении элементов матрицы
    public boolean isDetEqual(double value, double eps) {
        double deteps = 2 * getNorm1() * eps; // погрешность в определении
                                              // детерминанта
