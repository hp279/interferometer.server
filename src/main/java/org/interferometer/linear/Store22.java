...
public final class Store22 implements PhysicalStore<Double> {
    ...
    public double doubleValue(int aRow, int aCol) {
        return aRow == 0 ? (aCol == 0 ? a11 : (aCol == 1 ? a12
                : (new double[2][2])[aRow][aCol]))
                : (aRow == 1 ? (aCol == 0 ? a11 : (aCol == 1 ? a12
                        : (new double[2][2])[aRow][aCol]))
                        : (new double[2][2])[aRow][aCol]);
    }
    ...
    public Double aggregateAll(Aggregator aVisitor) {
        final AggregatorFunction<Double> tmpFunction = aVisitor
    ...
    public MatrixStore<Double> multiplyLeft(MatrixStore<Double> aStore) {
        ...
        return new Store22(A.a11 * a11 + A.a12 * a21,
                A.a11 * a12 + A.a12 * a22, A.a21 * a11 + A.a22 * a21, A.a21
                        * a12 + A.a22 * a22);
    }
    ...
    public MatrixStore<Double> multiplyRight(MatrixStore<Double> aStore) {
        ...
        return new Store22(a11 * B.a11 + a12 * B.a21,
                a11 * B.a12 + a12 * B.a22, a21 * B.a11 + a22 * B.a21, a21
                        * B.a12 + a22 * B.a22);
    }
    ...
    @Override
    public void visitColumn(int aRow, int aCol,
    ...
    @Override
    public void visitDiagonal(int aRow, int aCol,
            AggregatorFunction<Double> aVisitor) {
        if (aRow == 0) {
            if (aCol == 0) {
                aVisitor.invoke(a11);
    ...
    public void fillByMultiplying(MatrixStore<Double> aLeftStore,
        ...
        Store22 A = (Store22) aLeftStore, B = (Store22) aRightStore;
    ...
    public void fillMatching(MatrixStore<Double> aLeftArg,
        ...
        Store22 A = (Store22) aLeftArg, B = (Store22) aRightArg;
