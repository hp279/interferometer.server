...
public class GridSet extends FlatSet {
    ...
    public GridSet makeIntersection(GridSet a, GridSet b) {
        return new GridSet(Rectangle.makeIntersection(a.rect, b.rect), a.xstep, a.ystep, 
                           new Intersection(a.basic_set, b.basic_set));
    }
    /** объединение - предполагаем, что решетки совпадают */
    public GridSet makeUnion(GridSet a, GridSet b) {
        return new GridSet(Rectangle.makeRectUnion(a.rect, b.rect), a.xstep, a.ystep, 
                           new Union(a.basic_set, b.basic_set));
    }
