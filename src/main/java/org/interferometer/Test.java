...
public class Test {
    static void testSolver() // проверка, как работает квадратичное
                             // программирование
    {
    ...
    static void testRestore1() // проверка восстановления 1-мерной функции по
                               // разности
    {
    ...
    static FlatSet getTestSet(double r, double R) {
        ...
        Rectangle ulrect = new Rectangle(-Double.MAX_VALUE, -Double.MAX_VALUE,
                xcenter, ycenter);
