...
/*        System.out.printf("\nVertices: ");
        Border.EdgePoint points[] = new Border.EdgePoint[this.getVertexCount()];
        this.getVertices().toArray(points);        
        Arrays.sort(points);
	...
	private Border getComponentFromEdge(Border.EdgePoint pt, Set<Border.EdgePoint> points) throws BorderException {
     ...
     // идём вперёд:
        do {
            current_border = Utils.getAnotherIncidentEdge(this, nextpt, current_border);
...
//            System.out.printf("\n nextpt = %s", nextpt.toString()); 
    ...
    private Border getComponentFromMiddle(Border.EdgePoint pt, 
        ...
        Border.EdgePoint nextpt = pt,
                                 lastpt = null;
        points.remove(nextpt);
        Pair<Border, Double> current_border = Utils.getAnyIncidentEdge(this, nextpt),
