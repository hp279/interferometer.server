...
public class TableFunction extends AbstractFunction1 {
    ...
    public double getArgument(int i) {
        return (a + delta * i)
                * (i == 0 ? (1 + 1e-15) : (i == y.length - 1 ? (1 - 1e-15) : 1)); // чтобы
                                                                                  // всё
                                                                                  // попадало
                                                                                  // в
                                                                                  // интервалы
    ...
    public void assign(UnaryFunction<Double> f) // записываем значение другой
                                                // функции f
    {
    ...
    public void append(UnaryFunction<Double> f) // прибавляем значение другой
                                                // функции f
    {
        for (int i = 0; i < y.length; ++i)
